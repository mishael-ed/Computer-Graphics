...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/sky.png"));
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/clouds.png"));
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/landscape.png"));
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/coins.png"));
